        ...
        return [
            ...
            TD::make('capabilities', 'Capabilities')
                ->render(function (AiModel $model) {
                    ...
                    if (!empty($tools['reasoning'])) {
                        $icons[] = '<span class="badge bg-danger rounded-circle me-1" style="width: 28px; height: 28px; display: inline-flex; align-items: center; justify-content: center;" title="Advanced Reasoning">
