...
use App\Services\Models\ModelImportPolicyService;
...
class ModelSettingsService
{
    ...
    /**
     * @var ModelImportPolicyService
     */
    protected $modelImportPolicyService;
    ...
    public function __construct(
        ...
        ModelImportPolicyService $modelImportPolicyService
    ) {
        $this->providerSettingsService = $providerSettingsService;
        $this->aiProviderFactory = $aiProviderFactory;
        $this->modelImportPolicyService = $modelImportPolicyService;
    }
    ...
    /**
     * Import models from API response using policy service
     *
     ...
     */
    public function importModelsFromApiResponse(int $providerId, array $apiResponse, bool $activateNewModels = false): array
    {
        return $this->modelImportPolicyService->processSingleProviderModels(
            $providerId,
            $apiResponse,
            $activateNewModels
        );
    ...
    /**
     * Import models from bulk refresh using policy service
     *
     * @param int $providerId Provider ID
     * @param array $apiResponse Raw API response
     * @return array Import results with success status and statistics
     */
    public function importModelsFromBulkRefresh(int $providerId, array $apiResponse): array
    {
        return $this->modelImportPolicyService->processBulkRefreshModels(
            $providerId,
            $apiResponse
        );
    }
