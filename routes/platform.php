...
use App\Orchid\Screens\ModelSettings\AiModelSettingsScreen;
...
Route::screen('/models/settings', AiModelSettingsScreen::class)
    ->name('platform.models.settings')
    ->breadcrumbs(fn (Trail $trail) => $trail
        ->parent('platform.index')
        ->push(__('Model Settings'), route('platform.models.settings')));
