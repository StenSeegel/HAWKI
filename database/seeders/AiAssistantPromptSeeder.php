...
class AiAssistantPromptSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $systemPrompts = [
            ...
            // Labels that separate the parts of the text the title generator is
            // given: the uploaded file names, the request and the answer to it.
            [
                'category' => 'utility',
                'title' => 'Name Attachment Label',
                'description' => 'Bezeichnung der Dateinamen in der Eingabe der Titelerstellung',
                'content' => 'Datei:',
                'language' => 'de_DE',
                'created_by' => 1,
            ],
            [
                'category' => 'utility',
                'title' => 'Name Attachment Label',
                'description' => 'Label for the file names in the title generation input',
                'content' => 'File:',
                'language' => 'en_US',
                'created_by' => 1,
            ],
            [
                'category' => 'utility',
                'title' => 'Name Request Label',
                'description' => 'Bezeichnung der Anfrage in der Eingabe der Titelerstellung',
                'content' => 'Anfrage:',
                'language' => 'de_DE',
                'created_by' => 1,
            ],
            [
                'category' => 'utility',
                'title' => 'Name Request Label',
                'description' => 'Label for the request in the title generation input',
                'content' => 'Request:',
                'language' => 'en_US',
                'created_by' => 1,
            ],
            [
                'category' => 'utility',
                'title' => 'Name Response Label',
                'description' => 'Bezeichnung der Antwort in der Eingabe der Titelerstellung',
                'content' => 'Antwort:',
                'language' => 'de_DE',
                'created_by' => 1,
            ],
            [
                'category' => 'utility',
                'title' => 'Name Response Label',
                'description' => 'Label for the response in the title generation input',
                'content' => 'Response:',
                'language' => 'en_US',
                'created_by' => 1,
            ],
