    ...
    <div class="create-panel">
        ...
        <div id="createEditView" class="create-panel-content relative" style="display: flex; flex-direction: column; flex: 1; min-height: 0; padding: 0;">
            ...
            <div id="tiptapToolbar" class="tiptap-toolbar">
                <button type="button" class="toolbar-btn" data-command="toggleHeading" data-level="1" title="{{ $translation['Toolbar_Heading1'] ?? 'Überschrift 1' }}">H1</button>
                <button type="button" class="toolbar-btn" data-command="toggleHeading" data-level="2" title="{{ $translation['Toolbar_Heading2'] ?? 'Überschrift 2' }}">H2</button>
                <button type="button" class="toolbar-btn" data-command="toggleHeading" data-level="3" title="{{ $translation['Toolbar_Heading3'] ?? 'Überschrift 3' }}">H3</button>
                <div class="toolbar-divider"></div>
                <button type="button" class="toolbar-btn" data-command="toggleBold" title="{{ $translation['Toolbar_Bold'] ?? 'Fett' }}"><b>B</b></button>
                <button type="button" class="toolbar-btn" data-command="toggleItalic" title="{{ $translation['Toolbar_Italic'] ?? 'Kursiv' }}"><i>I</i></button>
                <button type="button" class="toolbar-btn" data-command="toggleStrike" title="{{ $translation['Toolbar_Strikethrough'] ?? 'Durchgestrichen' }}"><s>S</s></button>
                <div class="toolbar-divider"></div>
                <!-- AI Quote Button -->
                <button type="button" class="toolbar-btn" data-command="toggleBlockquote" title="{{ $translation['Toolbar_Quote'] ?? 'Zitat' }}" spellcheck="false" data-gramm="false" data-lt-active="false">
                ...
                <div class="toolbar-divider"></div>
                <button type="button" class="toolbar-btn" data-command="toggleBulletList" title="{{ $translation['Toolbar_BulletList'] ?? 'Aufzählung' }}">
                ...
                <button type="button" class="toolbar-btn" data-command="toggleOrderedList" title="{{ $translation['Toolbar_OrderedList'] ?? 'Nummerierte Liste' }}">
                ...
                <button type="button" class="toolbar-btn" data-command="liftListItem" title="{{ $translation['Toolbar_Outdent'] ?? 'Ausrücken' }}">
                ...
                <button type="button" class="toolbar-btn" data-command="sinkListItem" title="{{ $translation['Toolbar_Indent'] ?? 'Einrücken' }}">
                ...
                <div class="toolbar-divider"></div>
                <button type="button" class="toolbar-btn" data-command="toggleCode" title="{{ $translation['Toolbar_Code'] ?? 'Code' }}">
                ...
                <button type="button" class="toolbar-btn" data-command="toggleCodeBlock" title="{{ $translation['Toolbar_CodeBlock'] ?? 'Code Block' }}">
                ...
                <div class="toolbar-divider"></div>
                <button type="button" class="toolbar-btn" data-command="insertTable" title="{{ $translation['Toolbar_InsertTable'] ?? 'Tabelle einfügen' }}">
