            ...
            <div id="tab-korrekturen" class="tab-content tab-content-wrapper hidden">
                ...
                <div class="transcript-main-view">
                    <div class="transcript-view-header panel-header">
                        ...
                        <div style="flex: 1; display: flex; align-items: center;">
                            <span class="transcript-view-title" style="text-transform: uppercase;">{{ $translation["TranscriptAiTranscriptLabel"] ?? 'KI-TRANSKRIPT' }} <span class="transcript-view-divider">|</span> {{ $translation["TranscriptCorrectionMode"] ?? 'Korrekturmodus' }}</span>
                        </div>
                        <div class="header-actions-container" style="display: flex; align-items: center; gap: 8px; justify-content: flex-end;">
                            <button id="undo-global-btn" class="btn-header-action" onclick="window.undoLastMove()" title="{{ $translation["TranscriptUndoAction"] ?? 'Aktion rückgängig machen' }}" disabled>
                            ...
                            <button id="optimize-speakers-btn" class="btn-header-action" onclick="window.optimizeSpeakersWithAI()" title="{{ $translation["TranscriptOptimizeSpeakersAI"] ?? 'Sprecher per KI optimieren' }}">
                ...
                <div id="editor-tools-sidebar" class="sidebar-tools sidebar-edit-tools hidden" style="gap: 8px;">
                    <h4 class="section-title field-label-uppercase" style="margin-top: 0; margin-bottom: 12px;">{{ $translation["TranscriptSpeakers"] ?? 'Sprecher' }} (<span id="sidebar-speaker-count">0</span>)</h4>
